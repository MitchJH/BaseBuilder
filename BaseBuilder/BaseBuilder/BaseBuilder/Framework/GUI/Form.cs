...
namespace BaseBuilder
{
    ...
    public class Form : GUIControl
    {
        ...
        protected List<GUIControl> controlsToDelete = new List<GUIControl>();
        ...
        public override void Update(MouseState mouseState, KeyboardState keyboardState)
        {
            ...
            foreach (GUIControl c in controls)
            {
                if (c.Clicked)
                {
                    if (c is RadioButton)
                    {
                        foreach (GUIControl r in controls)
                        {
        ...
        protected virtual void HandlerRemoveFocusFromChildren(GUIControl sender)
        {
            hasFocus = true;
            foreach (GUIControl c in controls)
        ...
        protected virtual void HandlerChidlFormClosed(GUIControl sender)
        {
        ...
        protected virtual void HandlerMeClicked(GUIControl sender)
        {
            if (!this.gotFocus)
            {
                foreach (GUIControl c in controls)
        ...
        protected virtual void HandlerRadioButtonClicked(GUIControl sender)
        {
            foreach (GUIControl c in controls)
            {
                if (c is RadioButton)
        ...
        public virtual void AddControl(GUIControl control)
        {
        ...
        /// </summary>
        public virtual void Close(GUIControl sender)
        {
        ...
        public virtual void ToggleBrothersOfChildEnabled(GUIControl child,bool enabled)
        {
            foreach (GUIControl c in controls)
            {
        ...
        /// </summary>
        public virtual List<GUIControl> Controls
        {
            get
            {
                return controls;
