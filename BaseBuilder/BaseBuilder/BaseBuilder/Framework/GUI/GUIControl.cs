...
{
    public enum TextPosition { Center, TopCenter };
    public delegate void EHandler(GUIControl sender);
    ...
    public abstract class GUIControl
    {
        ...
        public GUIControl parent; // parent contiaing this control, set from out side
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (text != "" && font != null)
            {
                ...
                if (textPosition == TextPosition.Center)
                    textPos = AbsPosition + new Vector2(positionWidthHeight.Width, positionWidthHeight.Height) / 2f - font.MeasureString(text) / 2f;
                else if (textPosition == TextPosition.TopCenter)
                    textPos = AbsPosition + new Vector2(positionWidthHeight.Width, 0) / 2f - font.MeasureString(text) / 2f;
                else
