...
namespace BaseBuilder
{
    ...
    public class DomainLeftRight : Form
    {
        ...
        protected virtual void ChildClicked(GUIControl sender)
        {
            if (onClick != null) onClick(this);
        }

        protected virtual void ChildMouseDown(GUIControl sender)
        {
            if (onMouseDown != null) onMouseDown(this);
        }

        protected virtual void ChildMouseMove(GUIControl sender)
        {
            if (onMouseMove != null) onMouseMove(this);
        }

        protected virtual void BtnLeft_Click(GUIControl sender)
        {
        ...
        protected virtual void BtnRight_Click(GUIControl sender)
        {
            index = (int)MathHelper.Clamp(index+1, 0, items.Count - 1);
